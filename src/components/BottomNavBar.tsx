...
export function BottomNavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50">
      <div className="max-w-lg flex justify-around items-center pb-safe px-4 h-20 mx-auto  bg-slate-950/90 backdrop-blur-xl border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
        {navItems.map((item) => {
          const isActive =
            item.to === '/'
