...
export const Route = createFileRoute('/salary/categories/edit/$id')({
  component: EditSalaryCategoryPage,
})

function EditSalaryCategoryPage() {
  const { id } = Route.useParams()
  const navigate = useNavigate()
  const { data: category, isLoading } = useGetSalaryCategoryById(id)
  const { data: wallets = [] } = useGetWallets()
  const updateCategory = useUpdateSalaryCategory()
