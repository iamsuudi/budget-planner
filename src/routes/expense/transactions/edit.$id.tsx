...
export const Route = createFileRoute('/expense/transactions/edit/$id')({
  component: EditExpenseTransactionPage,
})

function EditExpenseTransactionPage() {
  ...
  const handleSave = () => {
    ...
    updateInvoice.mutate(
      ...
      { onSuccess: () => navigate({ to: '/expense/transactions' }) },
    )
  }
  ...
  if (!invoice) {
    return (
      <div className="">
        <TopAppBar showBack backTo="/expense/transactions" />
  ...
  return (
    <div className="">
      ...
      <Page title="Edit Expense" description="Update this expense transaction.">
        ...
        <div className="mt-6 flex flex-col gap-3">
          ...
          <CancelButton to="/expense/transactions" />
          <button
